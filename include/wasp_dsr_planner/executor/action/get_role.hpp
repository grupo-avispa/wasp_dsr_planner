...
#ifndef PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__GET_ROLE_HPP_
#define PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__GET_ROLE_HPP_
...
/**
 * @class GetRole
 * @brief This BT action node insert a DSR node of type 'get_role' with the given question and port
 */
class GetRole : public DSRAction<get_role_node_type>
{
public:
  GetRole(
...
#endif  // PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__get_role_HPP_
