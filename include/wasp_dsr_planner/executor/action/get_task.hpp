...
#ifndef PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__GET_TASK_HPP_
#define PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__GET_TASK_HPP_
...
/**
 * @class GetTask
 * @brief This BT action node insert a DSR node of type 'get_task' with the given text
 */
class GetTask : public DSRAction<get_task_node_type>
{
public:
  GetTask(
...
#endif  // PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__GET_TASK_HPP_
