...
#ifndef PLANNER_AGENT__EXECUTOR__ACTION__GET_ALARM_HPP_
 ...
 */
class GetAlarm : public BT::CoroActionNode
{
public:
  GetAlarm(
  ...
  {
    return{
      BT::OutputPort<std::string>("alarm", "Person alarm"),
      BT::OutputPort<Goal>("goal", "Person goal")
    };
  }
...
#endif  // PLANNER_AGENT__EXECUTOR__ACTION__GET_ALARM_HPP_
