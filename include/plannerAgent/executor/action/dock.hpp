...
/**
 * @class Dock
 * @brief This BT action node insert a DSR node of type 'dock'.
 */
class Dock : public DSRAction<dock_node_type>
{
public:
  Dock(
...
#endif  // PLANNER_AGENT__EXECUTOR__EXECUTOR__ACTION__DOCK_HPP_
